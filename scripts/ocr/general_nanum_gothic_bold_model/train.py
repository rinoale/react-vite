#!/usr/bin/env python3
"""
Training launcher for nanum_gothic_bold font OCR model.

Reads training_config.yaml from the version folder and runs train.py.

Usage (from project root):
    python3 scripts/ocr/general_nanum_gothic_bold_model/train.py
    python3 scripts/ocr/general_nanum_gothic_bold_model/train.py --version a19
    python3 scripts/ocr/general_nanum_gothic_bold_model/train.py --resume
    python3 scripts/ocr/general_nanum_gothic_bold_model/train.py --num_iter 20000
"""
import argparse
import os
import subprocess
...
def main():
    ...
    print("=" * 60)
    print("  OCR Training Launcher — nanum_gothic_bold")
    print("=" * 60)
