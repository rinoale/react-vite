#!/usr/bin/env python3
"""
Training launcher for mabinogi_classic font OCR model.

Reads training_config.yaml from the version folder and runs train.py.

Usage (from project root):
    python3 scripts/ocr/general_mabinogi_classic_model/train.py
    python3 scripts/ocr/general_mabinogi_classic_model/train.py --version a19
    python3 scripts/ocr/general_mabinogi_classic_model/train.py --resume
    python3 scripts/ocr/general_mabinogi_classic_model/train.py --num_iter 20000
"""
import argparse
import os
import subprocess
...
def build_command(cfg, overrides):
    ...
    exp_name_prefix = training.get("exp_name", "mabinogi_classic_ocr")
...
def main():
    parser = argparse.ArgumentParser(description="Train mabinogi_classic OCR model")
    ...
    print("=" * 60)
    print("  OCR Training Launcher — mabinogi_classic")
    print("=" * 60)
